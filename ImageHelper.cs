...
namespace SchedulerBoilerplate.Helpers
{
    public class ImageHelper
    {
        ...
        public List<String> SearchForImages(string image)
        {
            ...
            List<String> images = FindImages(image, "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.97 Safari/537.11");
        ...
        public List<String> FindImages(String question, String userAgent)
        {
            ...
            try
            {
                ...
                */
                ...
                foreach (NSoup.Nodes.Element div_with_image in div_with_images)
                {
                    ...
                    Console.WriteLine("Url: " + v.Groups[1]);
                    //imageList.Add(v.Groups[1].ToString());
                    if (v != null && v.Groups.Count == 2)
                    {
                        if (v.Groups[1].Value != string.Empty)
                        {
            ...
            {
                this.Error = ex;
                Console.WriteLine("ImageHelper throw ex: ", ex);
            }
